...
var MenuCommand = function(kCommandStr, runImmediately) {
    ...
    if (runImmediately) {
        this.result = this.run(this.kCommandStr);
    }
};
 ...
 * @returns {*}
 */
MenuCommand.prototype.getCommand = function(kCommandStr) {
 ...
 * @param kCommandStr
 */
MenuCommand.prototype.setCommand = function(kCommandStr) {
    // Filter the command through getCommand to make sure it is a valid command.
    this.kCommandStr = this.getCommand(kCommandStr);
};

/**
 * Execute the menu command.
 */
MenuCommand.prototype.run = function(kCommandStr) {
    try {
        var result = app.executeMenuCommand(kCommandStr);
